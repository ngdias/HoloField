...
*/
export const HeightFieldDecoder = (boundary) => ({
    metadata: {
 ...
 * @document ../../../docs/concepts/decoders.md
 */
export const RadialDecoder = (boundary) => ({
    metadata: {
    ...
    */
    length(position) {
        return Math.sqrt(position.x * position.x +
