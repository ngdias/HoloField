...
export const SetPageLayout = (layout) => {
    ...
    document
        ...
        .forEach(element => {
        element.classList.toggle("hidden", !visible.includes(element.id));
    });
};
...
export const PopulateSelect = (selectElement, module, { placeholder = "-- Select --", placeholderValue = "", placeholderDisabled = true } = {}) => {
