 ...
 */
export const FruityField: BoundaryField = {
 ...
 */
export const SimpleHeightField: BoundaryField = {
...
*/
export const PolarHeightField: BoundaryField = {
...
*/
export const HemisphereField: BoundaryField = {
...
*/
export const LatitudeBandsField: BoundaryField = {
